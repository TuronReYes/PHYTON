    ...
    if portal_choice == "1":
        ...
        while True:
            ...
            while True:
                ...
                print(f"Full Name  : {register_full_name}")
                print(f"Username   : {register_username}")
                print(f"Section    : {register_section}")
    ...
    if portal_choice == "2":
        ...
        if login_success == True:
            ...
            while True:
                ...
                print(f"Welcome, {register_full_name}")
                    ...
                    while True:
                        ...
                        if cashier_choice == "1":
                            ...
                            while True:
                                ...
                                print(f"Student Name : {register_full_name}")
                                print(f"Section      : {register_section}")
                    ...
                    while True:
                        ...
                        if calculator_choice == "1":
                            ...
                            while True:
                                ...
                                oral_cal = input("Oral Communication: ")
                                if oral_cal == "":
                                    oral_cal = 0
                                else:
                                    oral_cal = float(oral_cal)

                                read_writing_cal = input("Reading and Writing: ")
                                if read_writing_cal  == "":
                                    read_writing_cal = 0
                                else:
                                    read_writing_cal  = float(read_writing_cal )

                                century_cal = input("21st Century Literature: ")
                                if century_cal == "":
                                    century_cal = 0
                                else:
                                    century_cal = float(century_cal)

                                genmath_cal = input("General Mathematics: ")
                                if genmath_cal == "":
                                    genmath_cal = 0
                                else:
                                    genmath_cal = float(genmath_cal)

                                perdev_cal = input("Personal Development: ")
                                if perdev_cal == "":
                                    perdev_cal = 0
                                else:
                                    perdev_cal = float(perdev_cal)

                                science_cal = input("Earth and Life Science: ")
                                if science_cal == "":
                                    science_cal = 0
                                else:
                                    science_cal = float(science_cal)

                                pr_cal = input("Practical Research: ")
                                if pr_cal == "":
                                    pr_cal = 0
                                else:
                                    pr_cal = float(pr_cal)

                                pe_cal = input("Physical Education and Health: ")
                                if pe_cal == "":
                                    pe_cal = 0
                                else:
                                    pe_cal = float(pe_cal)
                                ...
                                #Calculate Grade
                                total_grade = (oral_cal +  read_writing_cal + century_cal + genmath_cal  + perdev_cal + science_cal + pr_cal + pe_cal)
                    ...
                    while True:
                        ...
                        if library_choice == "1":
                            ...
                            while True:
                                ...
                                print("1. Practical Research 1 / Practical Research 2")
                                print("2. General Mathematics")
                                print("3. Earth and Life Science")
                        ...
                        #Borrow Book
                            ...
                            while True:
                                ...
                                if book_choice == "1":
                                    borrowed_book = "Practical Research 1 / Practical Research 2"

                                elif book_choice == "2":
                                    borrowed_book = "General Mathematics"

                                elif book_choice == "3":
                                    borrowed_book = "Earth and Life Science"

                                elif book_choice == "4":
                                    borrowed_book = "Personal Development"
                ...
                #Student Schedule
                    ...
                    while True:
                        ...
                        print("\nTuesday")
                        print("8:00 AM - 10:00 AM   - Oral Communication")
                        print("10:00 AM - 11:30 AM  - Reading and Writing")
                        print("11:30 AM - 1:00 PM   - 21st Century Literature")

                        print("\nWednesday")
                        print("No classes")

                        print("\nThursday")
                        print("7:30 AM - 9:30 AM   - General Mathematics")
                        print("9:30 AM - 11:30 AM  - Personal Development")

                        print("\nFriday")
                        print("8:00 AM - 9:30 AM   - Earth and Life Science")
                        print("9:30 AM - 11:30 AM  - Practical Research")
                        print("11:30 AM - 1:00 PM   - Physical Education and Health")
